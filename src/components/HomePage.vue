    ...
    <div class="home-page bg-grey-lightest text-justify font-sans">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex">
                ...
                <div class="w-full w-2/3 p-4">
                    <p class="text-xl sm:text-xs md:text-lg fon">
