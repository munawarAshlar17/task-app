                ...
                <div class="flex">
                    ...
                    <div class="w-full w-1 bg-grey-light p-4">
                        <div v-bind:key="task.id" v-for="task in taskslist" class="single-blog">
                            <router-link class="no-underline text-blue-darkest text-lg font-semibold capitalize hover:text-blue-light text-center" v-bind:to="'/task/edit/'+ task.id"><li class=" text-center ">{{task.name}} <i class="far fa-edit"></i></li> </router-link>
                        </div>
                    </div>
                    <!--<div class="w-full w-1/3"></div>-->
